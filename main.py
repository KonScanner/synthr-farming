...
if __name__ == "__main__":
    ...
    for _ in range(ACTION_MULTIPLIER):
        ...
        synthr_faucet_token_amount = int(
            2 * 1e18 + random.randint(0, 100) * 1e18
        ...
        # Issue sUSD
        issue_amount = 1000000000000000000000  + random.randint(0, 100000000)
        build_and_send_transaction(
            web3_client=web3,
            contract_address=main_contract_address,
            function_name="issueSynths",
        ...
        logging.warning(f"Difference from initial balance: {-diff} ETH, from {initial_balance} to {balance}")
